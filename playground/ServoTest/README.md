...
ServoTest runs a simple positioning routine, progressively moving the servo thru 0,45,90,135,180 degrees
to allow measurement of the positioning accuracy.
