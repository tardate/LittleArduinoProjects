...
issues with page addressing etc - things you otherwise need to take care of yourself.
...
So nothing real exciting, just proving it works. This is what it looks like in the console:
...
* [Arduino Cookbook](../../books/arduino-cookbook/) - 13.4 Adding External EEPROM Memory
