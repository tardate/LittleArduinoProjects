...
I covered programming an ATtiny with the Arduino ISP in [LEAP#070 Programming an ATtiny With ArduinoISP](../ProgrammingWithArduinoISP).
...
Designed with Fritzing: see [ProgrammingShield.fzz](./ProgrammingShield.fzz).
