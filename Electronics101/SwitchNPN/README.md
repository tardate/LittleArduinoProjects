...
This is a demonstration a standard switching circuit using an NPN transistor.
...
Here's a sample trace. It also illustrates the impact of the filter capacitor C3 - the first 5 cycles in the plot are without C3, the remainder with C3 in place.
