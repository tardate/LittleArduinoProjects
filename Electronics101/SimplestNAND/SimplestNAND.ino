/*
  ...
  SimplestNAND
  Use an Arduino to demonstrate the most basic transistor NAND gate, and plot the results with Processing

  For info and circuit diagrams see https://github.com/tardate/LittleArduinoProjects/tree/master/Electronics101/SimplestNAND
