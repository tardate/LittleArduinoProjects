...
* [recipe component listing](https://docs.google.com/spreadsheets/u/0/d/1DvQ9nwKsFgqqcfTcfvUZP0HOss5u7fmWuPLrtN9IgiM/pub?hl=en_US&hl=en_US&hl=en_US&single=true&gid=3&output=html)
...
* 4.1 Sending Debug Information from Arduino to Your Computer
    * see [LEAP#746 Serial Control](../../playground/SerialControl/)
...
* 4.5 Receiving Multiple Text Fields in a Single Message in Arduino
    * see [LEAP#747 Using TextFinder](../../playground/UsingTextFinder/)
...
* 5.1 Using a Switch
    * see [LEAP#728 Switch Inputs](../../playground/SwitchInputs/)
...
* 6.6 Detecting Vibration
    * see [LEAP#376 Piezo Vibration Detector and BPM Counter](../../playground/PiezoVibrationDetector/)
* 6.7 Detecting Sound
* 6.8 Measuring Temperature
* 6.9 Reading RFID Tags
* 6.10 Tracking the Movement of a Dial
    * see [LEAP#118 RotaryEncoderMethods](../../playground/RotaryEncoderMethods/)
...
* 6.14 Getting Location from a GPS
    * see [LEAP#387 GpsBasics](../../playground/GpsBasics/)
...
* 7.1 Connecting and Using LEDs
    * see [LEAP#003 LED Chaser](../../playground/LedChaser/)
* 7.2 Adjusting the Brightness of an LED
    * see [LEAP#002 Variable LED brightness with PWM](../../playground/VariableLED/)
* 7.3 Driving High-Power LEDs
* 7.4 Adjusting the Color of an LED
    * see [LEAP#169 RGB LED Module](../../playground/RGBLedModule/)
...
* 8.1 Controlling the Position of a Servo
    * see [LEAP#042 ServoTest](../../Kinetics/ServoMotors/ServoTest/)
...
* 8.6 Controlling Solenoids and Relays
    * see [LEAP#102 SolenoidControl](../../playground/SolenoidControl/)
...
* 9.2 Playing a Simple Melody
    * see [LEAP#051 El Jarabe Tapatío](../../playground/JarabeTapatio/)
* 9.3 Generating More Than One Simultaneous Tone
    * see [LEAP#019 Popcorn](../../playground/Popcorn/)
...
* 10.2 Decoding Infrared Remote Control Signals
    * see [LEAP#624 IR Dumper](../../playground/ir/Dumper/)
...
* 11.1 Connecting and Using a Text LCD Display
    * see [LEAP#006 Better with Bacon on an LCD](../../playground/BetterWithBacon/)
...
* 12.2 Using millis to Determine Duration
    * see [LEAP#457 Precision Timer](../../playground/PrecisionTimer/)
...
* 13.3 Interfacing to an External Real-Time Clock
    * see [LEAP#166 DS3231RTC Time Demo](../../playground/DS3231RTC/TimeDemo/)
* 13.4 Adding External EEPROM Memory
    * see [LEAP#188 Basic AT24C02 EEPROM Read/Write](../../playground/EEPROM/AT24C02/BasicReadWrite/)
...
* 14.1 Sending Messages Using Low-Cost Wireless Modules
    * see [LEAP#712 LPD433 Modules](../../Radio/LPD433/Modules/)
...
* 15.4 Requesting Data from a Web Server
    * see [LEAP#005 Heart Quotes](../../playground/HeartQuotes/)
...
* 17.4 Storing and Retrieving Strings in Program Memory
    * see [LEAP#020 Internals](../../playground/Internals/)
...
* 18.9 Measuring Analog Values Quickly
    * see [LEAP#458 FastAnalogRead](../../playground/FastAnalogRead/)
