...
> Latest addition:sparkles: [stringy/DemoBurner](./BoldportClub/stringy/DemoBurner) - burning a new demo mode for the Boldport Club Stringy, with a Ruby gem for MusicXML conversion to PIC assembler.
